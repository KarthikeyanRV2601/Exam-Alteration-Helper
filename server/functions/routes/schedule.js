...
router.post('/list', [
    ...
    check('request_status', 'request status is not valid').isIn(['none', 'pending', 'accepted', 'alloted'])
    ],async (req, res) => {
...
router.post('/change_account_status', [
    check('account_status', 'account status is not valid').isIn(['pending', 'rejected', 'accepted'])
    ],async (req, res) => {
...
router.post('/account_status', [
    check('account_status', 'account status is not valid').isIn(['pending', 'rejected', 'approved'])
    ],async (req, res) => {
